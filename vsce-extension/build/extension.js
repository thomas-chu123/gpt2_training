...
let globalStorage = {}
console.log("The Extension 'acts_ai' has started");
let helloWorld = vscode.commands.registerCommand('acts_ai.helloWorld',async function () {
...
let askQuestion = vscode.commands.registerCommand('acts_ai.askQuestion',async function () {
